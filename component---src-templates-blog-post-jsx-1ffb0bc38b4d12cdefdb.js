...
/***/ "./node_modules/prismjs/components lazy recursive ^\\.\\/prism\\-.*\\.js$":
/*!***********************************************************************************!*\
  !*** ./node_modules/prismjs/components lazy ^\.\/prism\-.*\.js$ namespace object ***!
  \***********************************************************************************/
...
webpackAsyncContext.id = "./node_modules/prismjs/components lazy recursive ^\\.\\/prism\\-.*\\.js$";
...
/* harmony import */ var _utils_Str2Codeblock__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/Str2Codeblock */ "./src/utils/Str2Codeblock.js");
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_0___default()(Template, _Component);
  ...
  _proto.render = function render() {
    ...
    html = Object(_utils_Str2Codeblock__WEBPACK_IMPORTED_MODULE_3__["default"])(html);
...
/* harmony import */ var _components_PostBody__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/PostBody */ "./src/components/PostBody.jsx");
...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_layouts_MainLayout__WEBPACK_IMPORTED_MODULE_4__["default"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_PostHeader__WEBPACK_IMPORTED_MODULE_5__["default"], {
      title: post.frontmatter.title
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_PostBody__WEBPACK_IMPORTED_MODULE_6__["default"], {
      html: post.html
...
/* harmony import */ var prismjs_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! prismjs/components */ "./node_modules/prismjs/components.js");
/* harmony import */ var prismjs_components__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prismjs_components__WEBPACK_IMPORTED_MODULE_3__);
...
function loadPrismLanguage(lang) {
  if (prismjs__WEBPACK_IMPORTED_MODULE_2___default.a.languages[lang]) return true;
  var langData = prismjs_components__WEBPACK_IMPORTED_MODULE_3___default.a.languages[lang]; // if(!langData) throw new Error(`Prism dosen't support ${lang}`)
  ...
  __webpack_require__("./node_modules/prismjs/components lazy recursive ^\\.\\/prism\\-.*\\.js$")("./prism-" + lang + ".js");
  return true;
}

/* harmony default export */ __webpack_exports__["default"] = (function (rawCodString) {
  var codeRegExp = /<pre><code class="language-(.*?)">([\s\S]+?)<\/code><\/pre>/g; // ??? 不懂为什么会有两个重复的返回值
  // codeRegExp.exec(str)
  // @ref https://segmentfault.com/a/1190000002640851
  // @ref https://blog.csdn.net/lxcnn/article/details/4756030

  return rawCodString.replace(/<pre><code class="language-(.*?)">([\s\S]+?)<\/code><\/pre>/g, function (match, p1, p2) {
    // @BUG Prism 不支持 Shell 的语法高亮
    p1 = loadPrismLanguage(p1) ? p1 : 'html';
    var codeBlock = prismjs__WEBPACK_IMPORTED_MODULE_2___default.a.highlight(p2, prismjs__WEBPACK_IMPORTED_MODULE_2___default.a.languages[p1], p1);
...
//# sourceMappingURL=component---src-templates-blog-post-jsx-1ffb0bc38b4d12cdefdb.js.map