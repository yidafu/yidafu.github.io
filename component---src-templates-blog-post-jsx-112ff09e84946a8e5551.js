...
/***/ "./node_modules/prismjs/components sync recursive ^\\.\\/prism\\-.*\\.js$":
/*!******************************************************************!*\
  !*** ./node_modules/prismjs/components sync ^\.\/prism\-.*\.js$ ***!
  \******************************************************************/
...
webpackContext.id = "./node_modules/prismjs/components sync recursive ^\\.\\/prism\\-.*\\.js$";
...
var Prism = __webpack_require__(/*! prismjs */ "./node_modules/prismjs/prism.js"); // import components from 'prismjs/components'


var components = __webpack_require__(/*! prismjs/components */ "./node_modules/prismjs/components.js"); // import 'prismjs/plugins/prism-line-numbers.css'
// Prism.highlightAll()
...
function loadPrismLanguage(lang) {
  ...
  var langData = components.languages[lang]; // if(!langData) throw new Error(`Prism dosen't support ${lang}`)
  ...
  __webpack_require__("./node_modules/prismjs/components sync recursive ^\\.\\/prism\\-.*\\.js$")("./prism-" + lang + ".js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (rawCodString) {
  ...
  return rawCodString.replace(/<pre><code class="language-(.*?)">([\s\S]+?)<\/code><\/pre>/g, function (match, p1, p2) {
    ...
    var codeBlock = Prism.highlight(p2, Prism.languages[p1], p1);
...
//# sourceMappingURL=component---src-templates-blog-post-jsx-112ff09e84946a8e5551.js.map